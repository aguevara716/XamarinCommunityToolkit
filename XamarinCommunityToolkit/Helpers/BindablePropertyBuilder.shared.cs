...
namespace Xamarin.CommunityToolkit.Helpers
{
	public class BindablePropertyBuilder
	{
		...
		/// <returns>The same <see cref="BindablePropertyBuilder"/> to support the fluent syntax</returns>
		...
		/// <returns>The same <see cref="BindablePropertyBuilder"/> to suport the fluent syntax</returns>
